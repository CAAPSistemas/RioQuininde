...
import NotasSemestre1Basica from "./NotasSemestre1Basica";
import NotasSemestre2Basica from "./NotasSemestre2Basica";
import NotasSemestre3Basica from "./NotasSemestre3Basica";

export default function KeepMountedModalNotasBasica({
  idM,
  openNotasEB,
  handleOpenNotasEB,
  handleCloseNotasEB,
 clase
  ...
  const isOk = openNotasEB;
 const isOk2=openNotasEB;
  const isOK3 = openNotasEB;
  const isOk4=openNotasEB;
