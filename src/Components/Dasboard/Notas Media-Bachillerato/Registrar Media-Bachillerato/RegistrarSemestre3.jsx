...
export default function TestSemestre3({
  postNotas3,
  id3,
  idprofesor,
  grupoE,
  ...
  console.log(postNotas3, id3);
  //Semestre3
  useEffect(() => {
    const usuarioAEditar3 = postNotas3?.filter(
      (postNotas3) =>
        postNotas3.usuario === id3 && postNotas3.semestre === "Semestre3" && postNotas3.asignatura===clase
    );
    if (usuarioAEditar3) {
        ...
        <Grid item xs={12} sm={6} md={4} lg={3} xl={2}>
          <FormControl fullWidth>
            <OutlinedInput
              ...
              margin="dense"
              placeholder=" "
              value={aeditar3?.proyectofinal || ""}
              onChange={(e) =>
                setAeditar3({
                  ...aeditar3,proyectofinal: e.target.value,
                })
              }
            />
            <FormHelperText id="outlined-first-name-helper">
