...
export default function TestSemestre2Basica({
  ...
  console.log(postNotas2b, id2);
  //Semestre2
  useEffect(() => {
    const usuarioAEditar2 = postNotas2b?.filter(
      (postNotas2) =>
      postNotas2b.usuario === id2 && postNotas2.semestre === "Semestre2" && postNotas2.asignatura===clase
    );
    if (usuarioAEditar2) {
